...
Six patches against `open-vm-tools 13.1.0-25218885`, applied in order by the
...
| `0006-dndcp-any-desktop-file-drop` | Offers file drops on desktops other than GNOME and KDE. |
